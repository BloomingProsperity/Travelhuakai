    ...
    <>
      ...
      <header className="mb-6 flex flex-col gap-3 sm:flex-row sm:items-start sm:justify-between">
        ...
        <button
          type="button"
          onClick={handlePrint}
          className="print-this-page self-start rounded-full border border-border bg-card px-4 py-2 text-xs font-bold uppercase tracking-wider text-foreground shadow-sm transition hover:border-primary hover:text-primary"
        >
          Print this page
        </button>
      </header>

      <div className="grid min-w-0 items-start gap-6 lg:grid-cols-[200px_1fr_300px]">
        <CityNav />
        ...
        <div className="flex min-w-0 flex-col gap-12">
          ...
          <section className="flex flex-col gap-3 rounded-xl border border-dashed border-border bg-card p-6">
            ...
            <div className="flex flex-wrap gap-2 text-xs font-bold uppercase tracking-widest">
              <Link to="/ask" className="rounded-full border border-border bg-background px-3 py-1 hover:border-primary hover:text-primary">
                {isZh ? "向中国本地用户提问" : "Ask Chinese locals"}
              </Link>
              <Link to="/share" className="rounded-full border border-border bg-background px-3 py-1 hover:border-primary hover:text-primary">
