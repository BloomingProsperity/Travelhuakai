    ...
    cities: [
      {
        ...
        historyZh:
          "北京是中国最重要的历史都城之一，层次包括元大都、明清都城规划、近现代转型以及当代国家机构。",
    ...
    cities: [
      {
        ...
        museumRoleZh:
          "理解江南文化、港口城市成长、近现代都市生活以及上海参与全球交流的实用入口。",
        history:
        ...
        historyZh:
          "上海从江南县城和港口发展为通商口岸都市，随后成为现代工业、金融、出版、电影和城市文化的重要中心。",
    ...
    cities: [
      {
        ...
        museumRoleZh:
          "理解周秦汉唐、长安城市史、丝绸之路交流和帝国物质文化的清晰入口。",
        history:
        ...
        historyZh:
          "西安位于古代长安核心区域附近，是中国历史上重要都城之一，也是理解早期帝国制度和丝绸之路交流的关键城市。",
      ...
      },
      {
        ...
        museumZh: "咸阳博物院",
        museumRole:
          "Useful for understanding Qin imperial foundations and the political geography surrounding the ancient capital region.",
        museumRoleZh:
          "适合理解秦帝国基础，以及古都区域周边的政治地理。",
        history:
        ...
        historyZh:
          "咸阳与秦国、秦朝关系密切，是理解中国第一个大一统帝国兴起的重要背景城市。",
      ...
      },
      {
        ...
        museumZh: "延安革命纪念馆",
        museumRole:
          "The starting point for modern revolutionary history and the political memory of twentieth-century China.",
        museumRoleZh:
          "理解中国近现代革命史和二十世纪政治记忆的起点。",
        history:
        ...
        historyZh:
          "延安是理解中国革命时期、根据地叙事、制度建设和相关历史景观的核心城市。",
    ...
    cities: [
      {
        ...
        museumRole:
          "A strong entry point for the Central Plains, ancient capitals, ritual bronzes, early states, and Buddhist art.",
        museumRoleZh:
          "理解中原、古都、礼器青铜、早期国家和佛教艺术的重要入口。",
        history:
        ...
        historyZh:
          "洛阳是中国重要古都之一，关联二里头、东周、汉魏洛阳城、隋唐洛阳城和龙门佛教艺术。",
      ...
      },
      {
        ...
        museumZh: "开封博物馆",
        museumRole:
          "Best first stop for Northern Song urban history, river management, trade, and capital culture.",
        museumRoleZh:
          "理解北宋城市史、河流治理、商业贸易和都城文化的第一站。",
        history:
        ...
        historyZh:
          "开封与北宋都城汴京紧密相关，是商业、行政、文学和繁华城市生活的重要代表。",
      ...
      },
      {
        ...
        museumZh: "殷墟博物馆",
        museumRole:
          "The direct entry point for oracle bones, Shang royal archaeology, bronze culture, and early Chinese writing.",
        museumRoleZh:
          "理解甲骨文、商王朝考古、青铜文化和早期汉字的直接入口。",
        history:
        ...
        historyZh:
          "安阳对于理解殷墟晚商都城、甲骨刻辞、早期国家礼制和中国古代考古证据非常关键。",
    ...
    cities: [
      {
        ...
        museumRole:
          "The first stop for Six Dynasties culture, Ming capital history, Republican-era history, and Jiangnan material culture.",
        museumRoleZh:
          "理解六朝文化、明初都城、民国历史和江南物质文化的第一入口。",
        history:
        ...
        historyZh:
          "南京在多个历史时期曾为都城，是理解南朝文化、明代国家建设和中国近现代政治史的重要城市。",
      ...
      },
      {
        ...
        museumZh: "苏州博物馆",
        museumRole:
          "A concise entry into Wu culture, literati gardens, canal trade, silk, painting, and urban refinement.",
        museumRoleZh:
          "进入吴文化、文人园林、运河贸易、丝绸、绘画和城市审美的简洁入口。",
        history:
        ...
        historyZh:
          "苏州与江南文化、古典园林、运河网络、丝绸生产，以及宋至明清以来的城市生活密切相关。",
      ...
      },
      {
        ...
        museumRole:
          "A strong starting point for Grand Canal culture, salt merchants, gardens, and Qing-era urban prosperity.",
        museumRoleZh:
          "理解大运河文化、盐商、园林和清代城市繁荣的强入口。",
        history:
        ...
        historyZh:
          "扬州是理解大运河、盐业商业、文学文化、园林，以及南北物资与人员流动的重要城市。",
    ...
    cities: [
      {
        ...
        museumRoleZh:
          "理解古蜀文化、盆地地理、城市生活、地方工艺，以及成都与四川整体文化景观关系的第一入口。",
        history:
        ...
        historyZh:
          "成都是四川盆地长期延续的城市中心，关联古蜀文明、秦汉整合、蜀汉记忆、商业和日常城市文化。",
      ...
      },
      {
        ...
        museumZh: "乐山博物馆",
        museumRole:
          "A practical entry for river geography, Buddhist carving, local trade, and the wider Emei-Leshan heritage landscape.",
        museumRoleZh:
          "理解河流地理、佛教造像、地方贸易和峨眉山—乐山整体遗产景观的实用入口。",
        history:
        ...
        historyZh:
          "乐山受到江河交汇、佛教大型造像、峨眉山关系和西南交通路线的共同塑造。",
...
export const administrativeSearchSeed = [
...
export const provinceAttractionSeed = {
  beijing: [
  ...
  heilongjiang: [
    ...
    { zh: "扎龙自然保护区", en: "Zhalong Nature Reserve" },
    { zh: "哈尔滨冰雪大世界", en: "Harbin Ice-Snow World" }
  ],
  shanghai: [
    { zh: "外滩", en: "The Bund" },
    { zh: "豫园", en: "Yu Garden" },
